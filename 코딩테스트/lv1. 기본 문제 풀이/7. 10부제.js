...
* 날짜의 일의 자리 숫자가 주어지고 7대의 자동차 번호의 끝 두 자리 수가
* 주어졌을 때 위반하는 자동차의 대수를 출력하는 프로그램을 작성하세요.
*
...
let carNum = [25, 23, 11, 47, 53, 17, 33];

/* ======= filter ======= */

function solution2(day, carNum) {
  return carNum.filter(v => v % 10 === day).length;
}

console.log('solution2 --->', solution2(1, carNum));
...
console.log('solution --->', solution(1, carNum));
